...
- Takes no time to build a simple (yet personnalized) application.
...
- UI (User interface) `r ey()`: what userswill interact with.
...
- That's the tricky part! We are not used to do that as `r rp()` users.

--

- Introduces dependencies among variables.
