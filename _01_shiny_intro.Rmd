...
.pull-left[
### An `r rp()` package
[`shiny`](https://cran.r- project.org/package=shiny) .font90[12/2012 (0.2.3) &nbsp; // &nbsp; 10/2022 (1.7.3)]
]
.pull-right[
.right[`r lg_shiny(24)`]
...
## `r rfa("comments")` What for?

--

### - interactive capabilities

### - micro-meso web applications tailor to our needs


--

## `r rfa("comments")` Why not another framework?
...
* Frontend : 
  - `r rfa("html5")` HTML, `r rfa("css3")` CSS3, `r rfa("js")` JavaScript 
...
- `r rp()` in back end! Use all `r rp()`'s capabilities (data analysis, visualization, etc.) in a Web application! 
...
- Takes some time to learn / more complex mental model
...
- Because it is more complex (another layer), it is worthwhile to really ponder whether a shiny application is necessary for what we wish to accomplish.


---
# UI vs Server / Backend vs Frontend

- Major distinctions made in web applications

--

- UI (User interface) `r ey()`: what users will interact with (operation are done inside your web browser, so on your computer)

--

- Server `r cg()` : the operations done under the hood on a remote computer (a server).
...
- With Shiny you are using `r rp()` to create both: 
  ...
  - `r ey()` `ui`: an **object** (a tag list, includes HTML content)
...
* **reactivity**!
    - **reactive programming** = **event-driven programming** the event is "data changed" (think "spreadsheet")
...
* BTW, If you use the inspector you'll see HTML, CSS and JavaScript, not the `r rp()` code!
...
- we are familiar with :
  - with **imperative programming**: "do this"
  - with **functional programming**: we create and call functions
  - with **array programming**: we apply operations on vectors
  - ... 
...
> "poor 1 L of cold water, stir in 30 mL of lemon juice and add a tablespoon of map syrup"

--

- **declarative programming**:
> "you have 1 L of cold water, 30 mL of lemon juice and a tablespoon of map syrup, make me a lemonade"
...
* depends on an input (reactive values or another reactive expression)
...
* Fahrenheit to Celsius
  * hint: make `temp` your reactive variable that have the temperature in Fahrenheit
...
### Special cases used all the time to let Shiny do its magic!
